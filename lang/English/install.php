...
'Already installed'				=>	'It seems like NotionBB is already installed. You should go <a href="index.php">here</a> instead.',
'You are running error'			=>	'You are running %1$s version %2$s. NotionBB %3$s requires at least %1$s %4$s to run properly. You must upgrade your %1$s installation before you can continue.',
'My FluxBB Forum'				=>	'My NotionBB Forum',
'Description'					=>	'Unfortunately no one can be told what NotionBB is - you have to see it for yourself.',
...
'No DB extensions'				=>	'This PHP environment does not have support for any of the databases that NotionBB supports. PHP needs to have support for either MySQL, PostgreSQL or SQLite in order for FluxBB to be installed.',
'Administrator username'		=>	'Administrator\'s username',
'Administrator email'			=>	'Administrator\'s email',
'Board title'					=>	'Board title',
'Base URL'						=>	'The URL (without trailing slash) of your NotionBB forum. This must be correct.',
'Required field'				=>	'is a required field in this form.',
'FluxBB Installation'			=>	'NotionBB Installation',
'Welcome'						=>	'You are about to install NotionBB. In order to install NotionBB, you must complete the form set out below. If you encounter any difficulties with the installation, please refer to the documentation.',
'Install'						=>	'Install NotionBB %s',
...
'Info 4'						=>	'The name of the database you want to install NotionBB on.',
...
'Existing table error'			=>	'A table called \'%susers\' is already present in the database \'%s\'. This could mean that NotionBB is already installed or that another piece of software is installed and is occupying one or more of the table names FluxBB requires. If you want to install multiple copies of FluxBB in the same database, you must choose a different table prefix',
...
'Alert cache'					=>	'<strong>The cache directory is currently not writable!</strong> In order for NotionBB to function properly, the directory <em>%s</em> must be writable by PHP. Use chmod to set the appropriate directory permissions. If in doubt, chmod to 0777.',
...
'FluxBB fully installed'		=>	'NotionBB has been fully installed! You may now <a href="index.php">go to the forum index</a>.',
